...
const ChatPage = () => {
  ...
  useEffect(() => {
    const handleNewMessage = message => dispatch(messagesActions.addMessage(message))
    const handleNewChannel = channel => dispatch(channelsActions.addChannel(channel))
    const handleRenameChannel = channel => dispatch(channelsActions.renameChannel(channel))
    const handleRemoveChannel = id => dispatch(channelsActions.removeChannel(id))
